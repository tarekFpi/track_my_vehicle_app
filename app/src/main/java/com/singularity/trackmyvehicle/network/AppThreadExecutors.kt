...
private val NETWORK_EXECUTOR = Executors.newFixedThreadPool(10)
private val LOGOUT_NETWORK_EXECUTOR = Executors.newFixedThreadPool(10)
private val MAIN_EXECUTOR = MainThreadExecutor()

/**
 * Utility method to run blocks on a dedicated background thread, used for io/database work.
 */
fun logoutThread(f : () -> Unit) {
    LOGOUT_NETWORK_EXECUTOR.execute(f)
}
fun ioThread(f : () -> Unit) {
