...
import kotlinx.android.synthetic.main.fragment_suspend_maintenance.*

class SuspendedMaintenanceDialog  :  DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        suspendMaintenceCloseBtn.setOnClickListener {
            dismiss()
        }

        SuspendedMantenace_callbtn.setOnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_suspend_maintenance, container, false);
    }
}