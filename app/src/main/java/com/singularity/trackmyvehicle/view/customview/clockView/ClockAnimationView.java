...
public class ClockAnimationView extends AppCompatImageView {
    ...
    @ColorRes
    private static final int FACE_COLOR = android.R.color.black;
    @ColorRes
    private static final int RIM_COLOR = android.R.color.white;
    private static final int ANIMATION_DURATION = 500;
    private static final float RIM_STROKE_WIDTH = 25f;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            this.facePaintColor = ta.getColor(R.styleable.ClockAnimationView_faceColor, ContextCompat
                    .getColor(context, FACE_COLOR));
